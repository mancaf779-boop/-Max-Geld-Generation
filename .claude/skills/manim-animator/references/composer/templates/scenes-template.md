...
## Scene 1: [Scene Name]
**Duration**: [ffprobe-measured duration, e.g., 8.23s — do NOT estimate; leave blank until audio is generated]
...
### Audio Sync (fill when video has narration)
- **Audio clip**: [absolute path to per-scene WAV/MP3, e.g., /path/to/project/scene1_hook.wav]
- **Measured duration**: [ffprobe result, e.g., 8.234s]
- **Sync strategy**: simple_mux | voiceover_plugin

---

## Scene 2: [Scene Name]
**Duration**: [ffprobe-measured duration]
**Purpose**: [Purpose]
...
### Audio Sync (fill when video has narration)
- **Audio clip**: [path]
- **Measured duration**: [ffprobe result]
- **Sync strategy**: simple_mux | voiceover_plugin
